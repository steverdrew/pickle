...
Rails.application.config.sorcery.submodules = [:user_activation, :remember_me, :reset_password, :external]
...
Rails.application.config.sorcery.configure do |config|
  ...
  #
  config.google.key = "720852335186.apps.googleusercontent.com"
  config.google.secret = "GX--dwI0n7ZLWRx_2Eb69bD5"
